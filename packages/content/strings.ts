...
const en = {
  ...
  more: {
    ...
    clearOffline: "Clear offline audio",
    clearOfflineConfirm:
      "Remove the downloaded audio from this device? You can download it again anytime.",
    clearOfflineCancel: "Cancel",
    clearOfflineConfirmCta: "Clear",
    aboutSection: "About",
    aboutApp: "About Plain Dharma",
    downloadBook: "Download the book",
    signedIn: "Signed in",
    signOut: "Sign out",
    deleteAccount: "Delete account",
    deleteAccountConfirm:
      "This permanently deletes your account and all your synced highlights and notes. This can’t be undone.",
    ...
    signInSub: "Highlights & notes across your devices",
    syncedSub: "Synced across your devices",
  },
  home: {
    kicker: "Plain Dharma",
    ...
    bookCtaPaperback: "Paperback on Amazon",
...
const zh: Strings = {
  ...
  more: {
    ...
    offlineSection: "离线",
    clearOffline: "清除离线音频",
    clearOfflineConfirm: "要从此设备移除已下载的音频吗？你可以随时重新下载。",
    clearOfflineCancel: "取消",
    clearOfflineConfirmCta: "清除",
    aboutSection: "关于",
    aboutApp: "关于 Plain Dharma",
    downloadBook: "下载这本书",
    signedIn: "已登录",
    signOut: "退出登录",
    deleteAccount: "删除账户",
    deleteAccountConfirm: "这将永久删除你的账户以及所有已同步的高亮和笔记，且无法撤销。",
    deleteAccountCta: "删除账户",
    deleteAccountError: "删除账户失败，请重试。",
    signInTitle: "登录以同步",
    signInSub: "在设备间同步高亮与笔记",
    syncedSub: "已在设备间同步",
  },
  home: {
    kicker: "Plain Dharma",
    ...
    bookCta: "免费下载",
    bookCtaPaperback: "在 Amazon 购买纸质书",
    bookCtaListen: "收听有声书",
    getTheApp: "下载应用",

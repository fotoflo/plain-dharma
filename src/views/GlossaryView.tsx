...
// NOTE: Glossary entries are not (yet) localized in strings.ts. They render
// in English regardless of locale. When a `glossary` section is added to
// the strings module, swap these for `getStrings(locale).glossary.entries`.

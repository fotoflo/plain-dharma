...
export const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { label: "Author — First name", value: "Alex" },
      { label: "Author — Last name", value: "Miller" },
      {
        label: "Contributors",
        value: "",
        note: "Leave empty. KDP's Author field is mandatory and role-locked, so Alex sits there out of necessity — NOT an authorship claim. The 'Translated & edited by' credit lives on the cover + Bowker. Do not check 'Author' framing anywhere you have a choice.",
      },

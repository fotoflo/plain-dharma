      ...
      <div className="relative mx-auto w-full max-w-3xl overflow-hidden px-6 py-16 sm:py-20">
        ...
        <article className="prose-dharma">
          ...
          <p>
            ...
            — but I’d never really read the suttas themselves. I tried in
            college, cramming them the night before exams — I was an East Asian
            Studies major, after all — and again many times over the years
            since: in Bali, in San Francisco, now here in Chiang Mai, surrounded
            by temples. Every time, the stiff language turned me back — and it
            was more than the language. Every <em>The Blessed One</em>, every{" "}
            <em>thus have I heard</em>, smacked of organized religion, the same
            way the Torah does: a god being worshipped, not a teacher being
            read.
          </p>
          <p>
            ...
            <em>The Dharma Bums</em>; the kindness in Thich Nhat Hanh’s smile.
            The strange, empty feeling of flying through the night down an empty
            highway, just off a plane in a new country —{" "}
            <em>
              is this life even real? Did I just get dropped here somehow?
            </em>{" "}
            And the moments of clarity, with yoga or meditation, or now that
            I’ve learned to practice, in a single deep breath: everything
            slowing down, the rising and the falling, the bones in the body.
          </p>
          <p>
            I’ve given up on it more than once. Taken all the way, Buddhism felt
            like it went too far: detach from everything, and where does that
          ...
          <p>
            ...
            his statue brings me a peace I can’t explain; I love the imagery and
            the little I know of the tradition; we keep a few small statues at
            home. And still — I don’t think he should be worshipped, and I know
            that isn’t a popular thing to say. He risks becoming a golden calf —
            a fingertip in a reliquary — and he tells you so himself, in{" "}
          ...
          <p>
            So one night, wide awake at 3 a.m., I asked Claude the plain
            question: what <em>did</em> he actually say?
          </p>
          <p>
          ...
          <p>
            ...
            dialect — lives on{" "}
            <Link href="/how-it-was-made/gen-z">its own page</Link>, for the
          ...
          <p>
            ...
            in a sea of Chinese characters. Taken by the coincidence, I started
            a conversation. She had just finished a 25-day vipassanā retreat,
            and she was generous with it: her teacher was wonderful, room 12b at
            such-and-such monastery, there between nine and ten each morning,
            here is his number — and a book. The book was the constant noting.
          </p>
          <p>
            ...
            same breath. The teaching was already working on me, and I was
            already failing it.
          </p>
          <p>
          ...
          <p className="font-sans text-sm leading-relaxed text-ink/60 not-prose">
            ...
            <Link href="/how-to-decide">Kālāma Sutta</Link> — the one teaching
            that says{" "}
          ...
          <p>
            ...
            — every Pāli-faithfulness pass is a commit you can open and read.
            And the human finishing is here: the working sessions and the
            marked-up proof. The diffs prove the work was real; the manuscript
            proves it was cared for.
          </p>
          <p>
            The translation was first drafted from the Pāli with the help of
            Claude; the illustrations began with Gemini; the first narration
            with ElevenLabs. Almost none of it was left as the machine made it —
            the Chinese still is, for now. And all of it is released into the
            public domain under{" "}
            <a
          ...
          <p>
            ...
            is how it divides us. To me it should mean the opposite: that we are
            all brothers — and that we might love one another the way{" "}
            <Link href="/loving-kindness">a mother loves her only child</Link>.
            Not the way Abraham loved his.
          </p>
          <p>
            Though maybe that’s unfair to Abraham. Maybe God makes it hard for
            us on purpose — so we can taste how sweet the good parts are.
          </p>
        </article>

...
What four? You watch the **body** as just body. {/* pause:0.3 */} You watch your **feelings** as just feelings. {/* pause:0.3 */} You watch your **mind** as just mind. {/* pause:0.3 */} You watch the **contents of experience** as just what they are. In each case you stay alert, clear, and aware, having set aside craving and distress toward the world."
...
"Now look at this body honestly, from the soles of the feet up and from the top of the head down — everything packed inside it: hair, nails, teeth, skin, flesh, sinews, bones, marrow, organs, blood, and all the rest.
...
So you watch your feelings as just feelings — sometimes from the inside, {/* pause:0.2 */} sometimes as they appear in themselves, sometimes both. You watch how a feeling arises, how it passes, how it arises and passes. You stay aware just enough to keep knowing and seeing clearly — not leaning on anything, not grasping at anything in the world. That's how a person watches feelings as just feelings."
...
So you watch the contents of experience as just what they are — sometimes from the inside, {/* pause:0.2 */} sometimes as they appear in themselves, sometimes both. You watch how they arise, how they pass, how they arise and pass. You stay aware just enough to keep knowing and seeing clearly — not leaning on anything, not grasping at anything in the world. That's how a person watches the contents of experience as just what they are.
...
Notice how attachment forms. Through the eyes, {/* pause:0.2 */} ears, {/* pause:0.2 */} nose, {/* pause:0.2 */} tongue, {/* pause:0.2 */} body, {/* pause:0.2 */} and mind, you make contact with the world — and attachment can arise through contact. See that binding as it forms, see it when it lets go, and understand how to keep it from forming again.

So you watch the contents of experience as just what they are — sometimes from the inside, {/* pause:0.2 */} sometimes as they appear in themselves, sometimes both. You watch how they arise, how they pass, how they arise and pass. You stay aware just enough to keep knowing and seeing clearly — not leaning on anything, not grasping at anything in the world. That's how a person watches the contents of experience as just what they are.

### The Seven Qualities of Awakening

Notice the qualities that support awakening when they're present, and learn how to grow them: clear attention, {/* pause:0.2 */} genuine investigation, {/* pause:0.2 */} energy, {/* pause:0.2 */} a settled gladness, {/* pause:0.2 */} calm, {/* pause:0.2 */} a collected mind, {/* pause:0.2 */} and an even, balanced steadiness. When each is there, know it; know how it took root and how to strengthen it.

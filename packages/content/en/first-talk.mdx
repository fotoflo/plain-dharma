...
"If you've left ordinary life behind to find the truth, {/* pause:0.8 */} there are two dead ends you shouldn't waste yourself on.
...
And what is that middle path that clears your sight and settles your mind — that leads to calm, real understanding, and true freedom? It's this — eight things to get right: {/* pause:0.5 */}
...
{/* pause:0.6 */} That's the middle path I found — {/* pause:0.3 */} the one that clears your sight and settles your mind, and leads to a calm, real understanding, and true freedom.
...
{/* pause:0.8 */} **Where it comes from.** It comes from craving — the restless wanting that keeps pulling you back for more, searching for satisfaction wherever it can be found: wanting pleasure, wanting to keep existing, {/* pause:0.4 */} wanting to stop existing.

{/* pause:0.8 */} **How it ends.** It's the complete fading-out of that very craving — finally letting it go, releasing it, holding on to none of it.

{/* pause:0.8 */} **The way there.** It's simply this same eightfold path: seeing clearly, living with intention, speaking honestly, acting decently, earning a living that does no harm, making steady effort, staying mindful, and focusing deeply. {/* pause:0.8 */}
...
As long as my understanding of these four truths — {/* pause:0.3 */} in all three steps, across all twelve points — {/* pause:0.3 */} wasn't completely clear, I didn't claim to be fully awakened. But once it *was* completely clear, then I knew I had woken up fully, with nothing left to do. And the certainty settled in me: *My freedom can't be shaken. This is the final birth.*

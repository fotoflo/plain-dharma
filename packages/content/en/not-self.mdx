...
He ran the same three questions through all five — body, feelings, perceptions, impulses, awareness — and every time the answer came back the same: always changing, never reliable, not worth calling "me." {/* pause:0.8 */}

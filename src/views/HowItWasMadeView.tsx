...
export function HowItWasMadeView() {
  return (
    <div className="relative mx-auto w-full max-w-3xl overflow-hidden px-6 py-16 sm:py-20">
      ...
      <header className="mb-12">
        ...
        <p className="mt-6 font-serif text-lg leading-relaxed text-ink/80">
          ...
          Buddha, and it hasn’t ended yet — the slow work of weighing every phrase
          against the Pāli, by hand, out loud, more than once.
        </p>
      </header>

      <figure className="mb-14 not-prose">
        <ZoomableImage
        ...
        <figcaption className="mt-3 text-center font-sans text-sm leading-relaxed text-ink/60">
          The printed proof, signed — the object all of this became.
        </figcaption>
      </figure>
      ...
      <article className="prose-dharma">
        ...
        <p>
          ...
          language. Every <em>The Blessed One</em>, every <em>thus have I
          heard</em>, smacked of organized religion, the same way the Torah does:
          a god being worshipped, not a teacher being read.
        </p>
        <p>
          But the dharma had reached me anyway — never through the scripture, but
          through everything around it. The imagery: mandalas, paintings on temple
          walls. The searching in D.T. Suzuki’s essays and Kerouac’s <em>The Dharma Bums</em>; the kindness in Thich Nhat Hanh’s smile. The
          strange, empty feeling of flying through the night down an empty highway,
          just off a plane in a new country — <em>is this life even real? Did I
          just get dropped here somehow?</em> And the moments of clarity, after
          yoga or meditation, or now that I’ve learned to practice, in a single
          deep breath: everything slowing down, the rising and the falling, the
          bones in the body.
        </p>
        <p>
          I came to it warily, though — I’ve given up on it more than once. Taken
          all the way, Buddhism felt like it went too far: detach from everything,
          and where does that leave you? Life is too beautiful to give up. The
          suffering is what makes it so. Frankl gave me the answer I could hold
          onto: meaning, found inside the suffering and not beyond it.
        ...
        <p>
          ...
          <Link href="/how-to-decide">How to Decide What to Believe</Link>: don’t
          accept something just because someone you respect said it,{" "}
          <em>even if that teacher is me</em>. I wanted to hear the teaching, not
          bow to the teacher. So one night, wide awake at 3 a.m., I asked Claude
          the plain question: what <em>did</em> he say?
        </p>
        <p>
        ...
        <blockquote>
          “This is my own plain-English rendering of the Pali rather than any one
          scholar’s copyrighted translation.”
        </blockquote>
        <p>
          ...
          sun came up I’d read all six in a single sitting, for the first time in
          my life understanding them.
        </p>

        <h2>The detour: a Gen-Z Buddha</h2>
        <p>
          My very next message — the second prompt, before there was even a
          second teaching — was a dumb, irresistible thought: <em>what if the
          Buddha were around today, how would he say it? What if he was… Gen
          Z?</em> No plan behind it, I was just curious — and the AI cranked the
          voice all the way to one edge:
        </p>
        <blockquote>
        ...
        <p>
          ...
          nothing I’d call <em>made</em>. But the plain rendering it came wrapped
          around was the opposite, and that contrast is the point — the book is
          what happens when you stop letting the machine talk and start arguing
          with it, line by line. Here’s the line that shipped:
        </p>
        <blockquote>
        ...
        <p>
          ...
          lives on <Link href="/how-it-was-made/gen-z">its own page</Link>, for
          the curious. It’s actually quite amusing.
        </p>
        ...
        <Figure
          ...
          caption={
            <>
              The opening of the Kālāma Sutta, fetched from SuttaCentral and read
              against the draft. Three points:{" "}
              <em>evaṃ kalyāṇo kittisaddo abbhuggato</em> means a fine reputation
              had spread, not just “heard of him”; the Pāli has him traveling{" "}
              <em>with</em> a large company of monks; and “shared their honest
              doubt” softens the plainer <em>upasaṅkamiṃsu</em> (approached) →{" "}
              <em>etadavocuṃ</em> (said this).
            </>
          }
        />

        <p>
          Take the monks the Buddha travels with in <em>How to Decide What to
          Believe</em>.
        </p>
        <blockquote>
          “The Buddha was traveling with many monks and came to a town called
          Kesaputta… They’d heard good things about him, so they came to meet him,
          and told him their doubt directly.”
        </blockquote>
        <p>
          We talked about a sangha of bhikkhus. We tried on many followers. We
          came back to looking for both — what readers would understand, and what
          was still true to the text.
        </p>
        ...
        <Figure
          ...
          caption={
            <>
              ...
              <em>kaṅkhā</em> + <em>vicikicchā</em> — doubt and uncertainty — and
              the teachers “glorify their own ideas” from <em>dīpenti jotenti</em>
              , to expound and to make shine (from <em>joti</em>, light). The
              Pāli, not a thesaurus, picks the English.
            </>
          }
        />

        <p>
          None of this was a fight — there was no adversary. Or the only adversary
          was the AI’s agreeableness: Claude told me I was right no matter how I
          put it. So the real work was against that.
        </p>
        <p>
          You can’t trust “it felt right” when the machine agrees with everything;
          you have to keep demanding the ground under the answer — fetch the Pāli,
          lay every term and its meanings out in a table — so you’re choosing from
          the real range, not from flattery.
        </p>
        <p>
          ...
          and because the canonical words are repeated so often, we wanted to show
          them too, beside ours.
        </p>
        <p>
          The decision leaves no trace in the final text.
        </p>
        ...
        <Figure
          ...
          caption={
            <>
              ...
              <em>parideva</em> (wailing), <em>domanassa</em> (“the closest anchor
              to depression”), <em>upāyāsa</em> (a churning, turbulent distress).
              The final line — “sorrow, wailing, pain, depression, despair” — was
              settled first by the meaning, then by ear: read aloud against the
              audiobook, over and over, for what it would actually sound like.
            </>
          }
        />
        ...
        <p>
          ...
          twenty stark Latin letters, <em>Dhammacakkappavattana</em>, in a sea of
          Chinese characters. Taken by the coincidence, I started a conversation.
          She had just finished a 25-day vipassanā retreat, and she was generous
          with it: her teacher was wonderful, room 12b at such-and-such monastery,
          there between nine and ten each morning, here is his number — and a
          book. The book was the constant noting.
        </p>
        <p>
          She was kind, and I wished her well. And then — editing, that very hour,
          the sutra that says to{" "}
          <Link href="/loving-kindness">
            love every living thing as a mother loves her only child
          </Link>{" "}
          — I caught myself. Did I? I’d wished her well and judged her
          in the same breath. The teaching was already working on me, and I was
          already failing it.
        </p>
        <p>
        ...
        <p className="font-sans text-sm leading-relaxed text-ink/60 not-prose">
          ...
          marked-up page is the{" "}
          <Link href="/how-to-decide">Kālāma Sutta</Link> — the one teaching that
          says{" "}
        ...
        <p>
          ...
          thirty thousand ElevenLabs credits, burned just trying them on different
          passages. The one I kept I had to fight: it misreads emotion, runs a
          little fast, a little slow. So I prompted it flat and calm and slow, then
          dragged it 20–30% slower still — cut, stitched, re-rendered and stitched
          back in, 700 milliseconds of silence dropped between sections to let them
          breathe — and finally re-recorded the whole thing through the API and
          joined it to a cover, a back cover, and a barcode. Claude designed those;
          my mom fixed them.
        </p>
        <p>
          ...
          eat; here’s my bowl. And all of it runs in three scripts — English, and
          Chinese in both Simplified and Traditional — though the Chinese is still
          as the machine rendered it. A friend has promised to edit it one day;
          until then, the{" "}
        ...
        <p>
          The translation was first drafted from the Pāli with the help of Claude;
          the illustrations began with Gemini; the first narration with
          ElevenLabs. Almost none of it was left as the machine made it — the
          Chinese still is, for now. And all of it is
          ...
          — copy it, print it, translate it, make it more human. That part’s up to
          you now.
        </p>

        <p className="mt-12 border-t border-divider/50 pt-10">
          So, dear reader: would you forgive this text its faults — and check it
          for yourself? Ask your own AI to hold it against the Pāli. Don’t take my
          word for it, or his, or its. Or better: don’t check it at all. Just sit, and
          read the six, or listen. They are guided meditations by the Buddha
          himself. Maybe they’ll work on you too — I’ve read them so many times now
          that I can feel them, slowly, making their way in.
        </p>
        <p>
          ...
          from Ishmael. Jews and Christians trace themselves to one son, Muslims to
          the other, and each has made the story about itself. That is how it
          divides us. To me it should mean the opposite: that we are all brothers
          — and that we might love one another the way{" "}
          <Link href="/loving-kindness">a mother loves her only child</Link>. Not
          the way Abraham loved his.
        </p>
        <p>
          Though maybe that’s unfair to Abraham. Maybe God makes it hard for us on
          purpose — so we can taste how sweet the good parts are.
        </p>
      </article>

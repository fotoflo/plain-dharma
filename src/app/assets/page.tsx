...
const DOWNLOADS: Record<Locale, [string, string, string][]> = {
  en: [
    ...
    ["downloads/plain-dharma-printshop-a5.pdf", "Print-shop interior (A5)", "A5, 12pt, B&W"],
    ["downloads/plain-dharma-printshop-a5-covers.pdf", "Print-shop covers (A5)", "A4, color, crop marks"],
    ["downloads/plain-dharma-printshop-a6.pdf", "Print-shop interior (A6)", "A6 pocket, 12pt, B&W"],
    ["downloads/plain-dharma-printshop-a6-covers.pdf", "Print-shop covers (A6)", "A4, color, crop marks"],
